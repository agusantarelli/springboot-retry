...
import com.example.springbootretry.SpringbootRetryApplicationTests__TestContext001_ApplicationContextInitializer;
...
public class AotTestContextInitializers__Generated {
  public static Map<String, Supplier<ApplicationContextInitializer<? extends ConfigurableApplicationContext>>> getContextInitializers(
    ...
    map.put("com.example.springbootretry.SpringbootRetryApplicationTests", () -> new SpringbootRetryApplicationTests__TestContext001_ApplicationContextInitializer());
    return map;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializerClasses(
    ...
    map.put("com.example.springbootretry.SpringbootRetryApplicationTests", SpringbootRetryApplicationTests__TestContext001_ApplicationContextInitializer.class);
    return map;
  }
}
