 ...
 */
public class SpringbootRetryApplicationTests__TestContext001_ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new SpringbootRetryApplicationTests__TestContext001_BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new SpringbootRetryApplicationTests__TestContext001_BeanFactoryRegistrations().registerAliases(beanFactory);
  }
